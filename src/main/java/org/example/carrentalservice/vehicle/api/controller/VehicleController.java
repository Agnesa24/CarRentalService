...
import org.example.carrentalservice.vehicle.application.service.VehicleApplicationService;
...
public class VehicleController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<VehicleResponse> update(@PathVariable Long id, @Valid
